...
import com.springcloud.agentportal.dto.OrigamiSubmissionRequest;
import com.springcloud.agentportal.dto.OrigamiSubmissionResponse;
import com.springcloud.agentportal.dto.OrigamiUpdateRequest;
 ...
 */
@FeignClient(name = "origamiClient", url = "${app.apis.origami.base-url}")
