package com.springcloud.agentportal.service;

import com.springcloud.agentportal.client.AgentPortalNotifierClient;
import com.springcloud.agentportal.client.OrigamiClient;
import com.springcloud.agentportal.client.RootsAiClient;
import com.springcloud.agentportal.dto.*;
import com.springcloud.agentportal.exception.SubmissionServiceException;
...
public class SubmissionService {
    ...
    @Value("${app.apis.origami.api-key}")
    private String origamiApiKey;

    @Value("${app.apis.rootsai.api-key}")
    private String rootsAiApiKey;

    @Value("${app.apis.agent-portal.api-key}")
